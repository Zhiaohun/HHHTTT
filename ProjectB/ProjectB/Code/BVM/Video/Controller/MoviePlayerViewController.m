...
- (void)viewDidLoad {
    ...
    // 创建AVPlayer
    self.playerItem = [AVPlayerItem playerItemWithURL:[NSURL URLWithString:self.listModel.data.playUrl]];
...
{
    self.currentTimeLabel = [[UILabel alloc]initWithFrame:CGRectMake(_width *0.86, _height-40, 100, 20)];
...
- (void)createButton
{
    ...
    startButton.frame = CGRectMake(15, _height-47, 32, 32);
...
- (void)createTitle
{
    UILabel *label = [[UILabel alloc]initWithFrame:CGRectMake(35, 20, 250, 30)];
    label.text = self.listModel.data.title;
