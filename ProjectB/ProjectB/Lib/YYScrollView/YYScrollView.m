...
-(void)setDefaultImage
{
   ...
   // _rightImageView.image=[UIImage imageNamed:[NSString stringWithFormat:@"%i.png",1]];
    [_leftImageView sd_setImageWithURL:[NSURL URLWithString:allPics[_imageCount-1]]];
    [_centerImageView sd_setImageWithURL:[NSURL URLWithString:allPics[0]]];
    [_rightImageView sd_setImageWithURL:[NSURL URLWithString:allPics[1]]];
